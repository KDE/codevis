...
in the [lvtplg package](../lvtplg/). Handlers may return application data structures, such as an "Entity". Those are
available in the [plugin data types file](../lvtplg/ct_lvtplg_plugindatatypes.h).
...
specification (There's an [example below](#examples)). And the `README.md` file should contain a brief description, and
