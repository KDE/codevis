// ct_lvtmdl_methodstablemodel.h                                         -*-C++-*-
...
#ifndef DEFINED_CT_LVTMDL_METHODSTABLEMODEL
#define DEFINED_CT_LVTMDL_METHODSTABLEMODEL
...
class LVTMDL_EXPORT MethodsTableModel : public QStandardItemModel {
    Q_OBJECT
  public:
    MethodsTableModel();
