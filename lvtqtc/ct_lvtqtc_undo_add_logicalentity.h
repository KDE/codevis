...
#ifndef DEFINED_CT_LVTQTW_UNDO_ADD_LOGICAL_ENTITY_H
#define DEFINED_CT_LVTQTW_UNDO_ADD_LOGICAL_ENTITY_H
...
class LVTQTC_EXPORT UndoAddLogicalEntity : public UndoAddEntityBase {
  public:
    UndoAddLogicalEntity(GraphicsScene *scene,
                         const QPointF& pos,
