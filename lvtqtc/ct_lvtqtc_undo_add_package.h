...
#ifndef DEFINED_CT_LVTQTW_UNDO_ADD_PACKAGE_H
#define DEFINED_CT_LVTQTW_UNDO_ADD_PACKAGE_H
...
class LVTQTC_EXPORT UndoAddPackage : public UndoAddEntityBase {
  public:
    UndoAddPackage(GraphicsScene *scene,
                   const QPointF& pos,
