...
MRichTextEdit::MRichTextEdit(QWidget *parent) : QWidget(parent) {
    ...
    f_link->setShortcut(static_cast<QKeySequence>(static_cast<int>(Qt::CTRL) + static_cast<int>(Qt::Key_L)));

    connect(f_link, SIGNAL(clicked(bool)), this, SLOT(textLink(bool)));

    // bold, italic & underline

    f_bold->setShortcut(static_cast<QKeySequence>(static_cast<int>(Qt::CTRL) + static_cast<int>(Qt::Key_B)));
    f_italic->setShortcut(static_cast<QKeySequence>(static_cast<int>(Qt::CTRL) + static_cast<int>(Qt::Key_I)));
    f_underline->setShortcut(static_cast<QKeySequence>(static_cast<int>(Qt::CTRL) + static_cast<int>(Qt::Key_U)));
    ...
    f_list_bullet->setShortcut(static_cast<QKeySequence>(static_cast<int>(Qt::CTRL) + static_cast<int>(Qt::Key_Minus)));
    f_list_ordered->setShortcut(static_cast<QKeySequence>(static_cast<int>(Qt::CTRL) + static_cast<int>(Qt::Key_Equal)));
    ...
    f_indent_dec->setShortcut(static_cast<QKeySequence>(static_cast<int>(Qt::CTRL) + static_cast<int>(Qt::Key_Comma)));
    f_indent_inc->setShortcut(static_cast<QKeySequence>(static_cast<int>(Qt::CTRL) + static_cast<int>(Qt::Key_Period)));
...
QString MRichTextEdit::toHtml() const {
    // only return html *if* there's text in it.
    // without this, the empty text has a lot of html metadata.
    const bool isTextEmpty = f_textedit->toPlainText().isEmpty();
    if (isTextEmpty) {
        return QString();
    }
...
void MRichTextEdit::insertImage() {
    QSettings s;
    QString attdir = s.value("rich-text-edit/general/filedialog-path").toString();
