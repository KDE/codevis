...
#include "internalkwidgetsaddons_export.h"
 ...
 * @since 4.7
 */
class INTERNALKWIDGETSADDONS_EXPORT KMessageWidget : public QFrame
{
    Q_OBJECT
...
public:
    ...
    /** Background color, used for animation when setting texts */
    void setBgColor(const QColor& color);
    QColor bgColor() const;
    Q_SIGNAL void bgColorChanged(const QColor& color);
...
Q_SIGNALS:
    ...
    void closeButtonVisibleChanged(bool closeButtonVisible);

    void messageTypeChanged(KMessageWidget::MessageType messageType);
